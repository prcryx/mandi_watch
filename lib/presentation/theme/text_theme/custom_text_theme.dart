...
class CustomTextTheme extends ThemeExtension<CustomTextTheme> {
  ...
  final TextStyle? bodyLbOnPrimaryLight;
  ...
  ThemeExtension<CustomTextTheme> copyWith({
    ...
    TextStyle? bodyLb,
    TextStyle? bodyLbOnPrimaryLight,
    ...
    return CustomTextTheme(
      ...
      bodyLb: bodyLb,
      bodyLbOnPrimaryLight: bodyLbOnPrimaryLight,
  ...
  ThemeExtension<CustomTextTheme> lerp(
    ...
    return CustomTextTheme(
      ...
      bodyLbOnPrimaryLight:
          TextStyle.lerp(bodyLbOnPrimaryLight, other.bodyLbOnPrimaryLight, t),
